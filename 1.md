...
3.  Select **SrinikaA -<inject key="DeploymentID" />**
4. Select ARCHOST-<inject key="DeploymentID" enableCopy="true" />-SQLVM
5. Select MPTESTINGWITHSPACE -<inject key="DeploymentID" enableCopy="true" />-SQLVM
6. Select nospace-<inject key="DeploymentID" enableCopy="true" />-SQLVM
7. Select NoSpace-<inject key="DeploymentID" enableCopy="true" />-SQLVM
